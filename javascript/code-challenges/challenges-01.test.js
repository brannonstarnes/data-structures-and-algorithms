...
const addOne = (arr) => {
  // Solution code here...
  const myArray = [];
  arr.forEach(number => myArray.push(number + 1));
  return myArray;
};
...
const addExclamation = (arr) => {
  // Solution code here...
  const myArray = [];
  //loop with forEach and push to the new array
  arr.forEach(string => myArray.push(string + '!'));
  return myArray;
};
...
const allUpperCase = (arr) => {
  const myArray = [];
  arr.forEach(string => myArray.push(string.toUpperCase()));
  return myArray;
};
...
const speaker = (words, callback) => {
  let myArray = [];
  words.forEach(string => myArray.push(callback(string)));
  // words.forEach(string => callback(string));
  return myArray;
};

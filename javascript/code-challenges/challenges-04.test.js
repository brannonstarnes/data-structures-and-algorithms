...
const updateAnimal = (arr, callback) => {
  ///create new array
  let newArray = [];
  //iterate over array and modify via callback and push to newArray
  arr.forEach(animal => newArray.push(callback(animal)));
  return newArray;
};
...
const sortNames = (arr) => {
  // take array, sort alphabetically
  let sortedArray = arr.sort();
  return sortedArray;
};
//NOTE Capital letters have a lower Unicode and sorted sorts by ascencion by default
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
